...
const MOODS = [
  ...
  { key: 'adventure', label: 'Adventure',    desc: 'Explore the world' },
];
      ...
      {open && (
        <div className="absolute bottom-full mb-2 left-0 z-50 w-72 bg-[var(--surface)] border border-[var(--border)] rounded-xl shadow-2xl overflow-hidden">
          <div className="p-3 border-b border-[var(--border)]">
            <p className="text-sm font-semibold text-foreground">Pick a mood</p>
          ...
          <div className="grid grid-cols-2 gap-1 p-2">
            {MOODS.map((mood) => (
              ...
              >
                ...
                <span className="text-sm text-foreground font-medium">{mood.label.split(' ').slice(1).join(' ')}</span>
